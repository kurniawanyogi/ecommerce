...
import (
	database "user-management-service/config/database"
...
func (_m *IRegistry) GetTx() *database.TransactionRunner {
	ret := _m.Called()
	...
	var r0 *database.TransactionRunner
	if rf, ok := ret.Get(0).(func() *database.TransactionRunner); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*database.TransactionRunner)
		}
	}
