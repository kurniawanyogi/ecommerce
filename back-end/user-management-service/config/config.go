...
type ColdFlat struct {
	...
	// DB Mysql
	Migration                    bool   `json:"migration" yaml:"migration"` // toogle to use golang-migrate or not
	...
	// Kafka
	KafkaHost                     string `json:"kafkaHost" yaml:"kafkaHost"`
	KafkaPort                     string `json:"kafkaPort" yaml:"kafkaPort"`
	KafkaTimeoutInMs              int32  `json:"kafkaTimeoutInMs" yaml:"kafkaTimeoutInMs"`
	KafkaProducerRetryMax         int32  `json:"kafkaProducerRetryMax" yaml:"kafkaProducerRetryMax"`
	KafkaProducerRetryBackoffInMs int    `json:"kafkaProducerRetryBackoffInMs" yaml:"kafkaProducerRetryBackoffInMs"`
}
...
type HotFlat struct {
	...
	ExpiredSignature      bool   `json:"expiredSignature" yaml:"expiredSignature"`
}
